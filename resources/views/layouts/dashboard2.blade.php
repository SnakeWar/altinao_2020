...
<head>
    ...
    <link rel="icon" href="http://172.17.192.161:8000/images/favicon.png" />

    <!-- Styles -->
    <link href="{{asset('css/style.css')}}" rel="stylesheet" type="text/css">

    <!-- Bootstrap core CSS-->
    <link href="http://172.17.192.161:8000/admin/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom fonts for this template-->
    <link href="http://172.17.192.161:8000/admin/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <!-- Custom styles for this template-->
    <link href="http://172.17.192.161:8000/admin/css/sb-admin.css" rel="stylesheet">
    ...
    <footer class="sticky-footer">
        <div class="container">
            <div class="text-center">
                <small>Desenvolvido por SnakeWar</small>
            </div>
        </div>
    </footer>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Selecione "Logout" abaixo se você está pronto para encerrar a sessão.</div>
